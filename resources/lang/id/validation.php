    ...
    */
    ...
    'custom' => [
        ...
        'nama_siswa' => [
            ...
            'max' => 'Kolom NAMA SISWA tidak boleh dari dari :max karakter',
        ],
        'jenis_kelamin' => [
            'required' =>'Kolom JENIS KELAMIN harus diisi.',
            'in' => 'Kolom JENIS KElAMIN harus diisi Pria atau Wanita',
        ],
        'tanggal_lahir' => [
        ...
        'nama_kelas' => [
            ...
            'max' => 'Nama Kelas Maks 20 karakter',
        ],
        'nama_hobi' => [
            'required' => 'Nama Hobi harus diisi.',
            'string' => 'Nama Hobi harus string',
            'max' => 'Nama Hobi Maks 20 karakter',
        ],
        'email' => [
